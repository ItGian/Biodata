...
const ProjectPortfolio: React.FC = () => {
  const projects: ProjectCardProps[] = [
    { title: "CRUD", description: "Making a 'Create Read Update Delete' Function using PHP and MySQL ", imageUrl: "/images/project 1.png" },
    { title: "Web Designing", description: "Making a Landing Page for Orphanage Website using HTML, CSS, JavaScript and Bootstrap", imageUrl: "/images/project 2.png" },
    { title: "Login/Register", description: "Making a Login/Register Page for Web using PHP and MySQL", imageUrl: "/images/project 3.png" },
    { title: "Web Designing", description: "Making a Landing Page with Dark Mode Function and the theme is to choose a random industry using HTML, CSS, JavaScript and Bootstrap ", imageUrl: "/images/project 4.png" },
  ];
