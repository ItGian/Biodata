    ...
    <section id="Experience">
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl  lg:py-16 lg:px-6">
                <div className="grid  gap-4 mt-8">
                    ...
                    <br></br>
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 bg-gray-900/50 rounded-lg">
      {/* Desktop view - two columns */}
      <div className="hidden md:grid md:grid-cols-2 text-center mb-4">
        <h2 className="text-gray-400 font-medium">EDUCATION</h2>
        <h2 className="text-gray-400 font-medium">EXPERIENCE</h2>
      </div>
      
      {/* Mobile view - section headers */}
      <div className="md:hidden space-y-6">
        <h2 className="text-gray-400 font-medium text-center">EDUCATION</h2>
        ...
        <h2 className="text-gray-400 font-medium text-center pt-8">EXPERIENCE</h2>
        <div className="space-y-6">
